...
class NeuronDictionary1D(dt.AbstractDictionary): # shallow_neural_dict with 1D inputs
    ...
    def __init__(self, 
        ...
        """
        super(NeuronDictionary1D, self).__init__()
        ...
        self.params_domain = param_b_domain
        self.param_mesh_size = params_mesh_size
    ...
    def _gather_vertical_param(self):
        ...
        # generate param-mesh for (w,b), where w only takes +1 and -1 
    ...
    def _select_initial_elements(self, pde_energy, best_k):
        ...
        # pick by subscripts
        w = all_theta[0][sub[:,0:1],sub[:,1:2]]
        b = all_theta[1][sub[:,0:1],sub[:,1:2]]
        initial_guess = torch.cat([w,b], dim=1).to(self.device)
    ...
    def _get_optimizer(self, theta, optimizer_type):
        ...
        # theta contains w (weight) and b (bias)
        w = theta[0]
        b = Parameter(theta[1])
        params_input = [b]
    ...
    def _argmax_optimize_seq(self, pde_energy, theta_list, optimizer_type):
        ...
        # each theta in the list should contain w and b
    ...
    def _argmax_optimize(self, pde_energy, theta_list, optimizer_type):
        ...
        INPUT:
            ...
            optimizer_type: options for choosing optimizers. Available for
                        ...
                        "fista", first-order-acceleratd PGD method,
                        "lbfgs", L-BFGS method.
        """
